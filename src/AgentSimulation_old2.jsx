...
const AgentSimulation = () => {
    ...
    const updateTrace = (prevTrace, newAgentPos) => {
        ...
        console.log("Trace Matrix (First 10 values):", trace.slice(0, 10)); 
    ...
    useEffect(() => {
        ...
        //     setAgentPos((prevPos) => ({
        //         x: (prevPos.x + AGENT_STEP_SIZE) % SCALE,  // Wrap around when reaching the edge
        //         y: (prevPos.y + AGENT_STEP_SIZE) % SCALE,  // Wrap around when reaching the edge
        //     }));
